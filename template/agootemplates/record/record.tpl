...
<div class="row"><?php echo $column_left; ?>
		...
		<?php if (	(isset ($settings_blog['view_date']) && $settings_blog['view_date'])
			...
			<div class="blog-small-record">
				<ul>
					...
					<li class="blog-comments-record" style="background: url(/image/comm-art.png) no-repeat center;background-size:contain;"><span><?php echo $tab_comment; ?>:<ins style="text-decoration:none;" class="comment_count"><?php echo $comment_count; ?></ins></span></li>
					<?php } ?>
				</ul>
			</div>
	...
	<div class="divider100"></div>
           ...
           <div class="nav nav-tabs <?php if (SC_VERSION <= 20 || $theme == 'journal2') { ?>htabs<?php } ?>" id="<?php if (SC_VERSION <= 20 || $theme == 'journal2') { ?>tabs<?php } else { ?>scp-tabs<?php } ?>">
		...
		<div class="share floatleft">
			<?php echo $language->get('share_text'); ?><?php echo $box_share; ?>
		</div>
		<div class="form-banner" style="width:100%;height:500px;background: url('/image/Bigbanner.jpg') no-repeat center;background-size:contain">
