...
<div class="cmswidget-new-<?php echo $cmswidget; ?>">
	<div class="container_reviews cmswidget" id="<?php echo $prefix;?>container_reviews_<?php echo $mark;?>_<?php echo $mark_id;?>">
		...
		<a class="textdecoration_none leavereview-<?php echo $cmswidget; ?>" href="<?php echo $href; ?>#<?php echo $prefix;?>comment-title"><ins class="hrefajax textdecoration_none"><?php echo $text_write_review; ?><?php if (SC_VERSION > 15) { ?>&nbsp;<?php } ?>&nbsp;&darr;</ins></a>
