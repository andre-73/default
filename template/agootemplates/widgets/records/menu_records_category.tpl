...
if (count($records) > 0) {
?>
<ul id="cmswidget-<?php echo $cmswidget; ?>" class="cmswidgets">
	<?php
		// prepare categories
				...
				<div class="dropdown-menu">
					...
					<ul class="list-unstyled">
						...
						if ($rec_id) {
							 ...
							 ?>
							 <li>
								<a <?php if (!$record['active']) echo 'href="'.$record['href'].'"'; ?> class="blog-title  <?php if ($record['active']) echo 'active'; if (!$record['active'])	echo 'pass'; ?>"><?php echo $record['name']; ?>aaa</a>
