...
echo 'colorbox_modal';
				...
				<div class="sc-widget-content side-art">
                   ...
                   (isset($settings_widget['avatar_status']) && $settings_widget['avatar_status'])) { ?>
					...
					<?php if ($record['thumb'] && isset($settings_widget['avatar_status']) && $settings_widget['avatar_status']) { ?>
						<div class="image <?php if (isset($settings_widget['title_status']) && $settings_widget['title_status'] && (isset($settings_widget['images_position']) && $settings_widget['images_position']=='after')) { ?> blog-image <?php } ?>">
