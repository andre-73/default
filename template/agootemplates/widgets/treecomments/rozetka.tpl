...
<div class="cmswidget-new-<?php echo $cmswidget; ?>">
	<div class="container_reviews cmswidget" id="<?php echo $prefix;?>container_reviews_<?php echo $mark;?>_<?php echo $mark_id;?>">
		...
		<!-- <a onclick="$('#<?php echo $prefix;?>comment_id_reply_0').click();" class="textdecoration_none leavereview-<?php echo $cmswidget; ?>" href="<?php echo $href; ?>#<?php echo $prefix;?>comment-title"><ins class="hrefajax textdecoration_none"><?php echo $text_write_review; ?><?php if (SC_VERSION > 15) { ?>&nbsp;<?php } ?>&nbsp;&darr;</ins></a>
 -->
		...
		<div id="<?php echo $prefix;?>div_comment_<?php echo $mark_id; ?>" >
			...
			<div id="<?php echo $prefix;?>comment-title" class="sc_tc_link_write_review">
				<span  id="<?php echo $prefix;?>comment_id_reply_0" data-cmswidget="<?php echo $cmswidget; ?>" data-prefix="<?php echo $prefix;?>" class="comment_reply comment_buttons form_reply"><?php echo $text_write; ?>
				</span>
			</div>
			...
			<div id="<?php echo $prefix;?>reply_comments" class="<?php echo $prefix;?>comment_form comment_form" data-prefix="<?php echo $prefix;?>" style="display:none">
				<div id="<?php echo $prefix;?>comment_work_" class="<?php echo $prefix;?>form_customer_pointer width100 margintop10">
					...
					<form id="<?php echo $prefix;?>form_work_">
                		...
                		<ins><?php echo $text_signer_answer_email; ?></ins>
						...
						<?php } else { ?>
				   			<div class="buttons">
				                <button type="button" id="<?php echo $prefix;?>button-comment-0" data-loading-text="" class="btn btn-primary button button-comment"><?php echo $button_write; ?></button>
				             </div>
						<?php } ?>
